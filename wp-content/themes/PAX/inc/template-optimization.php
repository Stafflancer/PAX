 ...
 * Disable the emojis.
 */
function template_disable_emojis() {
...
add_action( 'init', 'template_disable_emojis' );
 ...
 * @return void
 */
function template_deregister_scripts() {
	wp_dequeue_script( 'wp-embed' );
}

add_action( 'wp_footer', 'template_deregister_scripts' );
 ...
 * @return string
 */
function template_remove_script_version( $src ) {
	$parts = explode( '?ver', $src );

	return $parts[0];
}

add_filter( 'script_loader_src', 'template_remove_script_version', 15, 1 );
add_filter( 'style_loader_src', 'template_remove_script_version', 15, 1 );