 ...
 * @return void
 */
function pax_switch_theme() {
	switch_theme( WP_DEFAULT_THEME );
	unset( $_GET['activated'] );
	add_action( 'admin_notices', 'pax_upgrade_notice' );
}
add_action( 'after_switch_theme', 'pax_switch_theme' );
...
add_action( 'load-customize.php', 'pax_customize' );
...
add_action( 'template_redirect', 'pax_preview' );