<?php
/**
 * Slider - Cards with Icons Block Template.
 *
...
$id = 'slider-cards-with-icons' . $block['id'];
...
$section_class_name = 'slider-cards-with-icons';
...
pax_display_block_background_options( $block, $container_args );
	...
	<div class="slider-cards-outer"><?php
	if(!empty($cards)){ 
		pax_cards_section($cards);
	} ?>
	</div><?php
