<?php
/**
 * Side by Side (Map) Block Template.
 *
...
$section_class_name = 'side-by-side-map';
...
pax_display_block_background_options( $block, $container_args ); ?>
	<div class="side-by-side-map-outer">
		<div class="left-side-containt"><?php
